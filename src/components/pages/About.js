...
function About() {
    ...
    return (   
        ...
        <div className="container-content">
            ...
            <p style={Pstyle}> In a fast moving industry of web development staying on top of your game is vital and means 
                ...
                <br/>
                <br/>
                To become an asset to the company in which I will collaborate with and continue to grow. I seek a career in which I can apply the skills I've learned in my study of 
